<%@ Page Title="" Language="C#" MasterPageFile="~/ui/masterparent.Master" AutoEventWireup="true" CodeBehind="displayattendance(parent).aspx.cs" Inherits="edusystemv1.ui.displayattendance_parent_" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"><section id="main-content" style="background-color:#edf0f5;">
  ...
  <div>
    ...
    --%>
      ...
      <%-- Add student session --%>
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DAconnectionstring %>" SelectCommand="SELECT * FROM [student_attendance] WHERE stud_id = @ss order by date_today desc ">
            <SelectParameters>
