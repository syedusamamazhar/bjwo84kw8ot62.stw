<%@ Page Title="" Language="C#" MasterPageFile="~/ui/teacher.Master" AutoEventWireup="true" CodeBehind="teacherprofile.aspx.cs" Inherits="edusystemv1.ui.teacherprofile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section id="main-content" style="background-color:#edf0f5;">
      <section class="wrapper">
              ...
              <h1 style="padding-left:450px; color:black;"><strong>Staff Profile</strong></h1>
                      ...
                      <form id="Form1" class="form-horizontal style-form" runat="server" >
						  ...
						  <option>Gay</option>
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10" style="width:800px">
                                   <asp:TextBox ID="username" required="required" ReadOnly="true" CssClass="form-control" runat="server"></asp:TextBox>
                              </div>
                          </div>
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                   ...
                                   <div class="col-sm-10">
                                        <asp:DropDownList ID="type" required="required" Enabled="false" runat="server">          
						  ...
						  <option>Finance</option>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10" style="width:800px">
                                  <asp:TextBox ID="salary" required="required" ReadOnly="true" MaxLength="8" onkeypress="if(event.keyCode<48 || event.keyCode>57)event.returnValue=false;" CssClass="form-control" runat="server"></asp:TextBox>
                              </div>
                                     </div>
                                   <div class="form-group">
                              ...
                              <div class="col-sm-10" style="width:800px">
                                  ...
                                  <div style="color:green; margin-left:130px; bottom:50px;">
                                    <strong><asp:Label ID="Lable1" runat="server"/></strong>
                              </div>--%>
                              </div>
                          </div>
