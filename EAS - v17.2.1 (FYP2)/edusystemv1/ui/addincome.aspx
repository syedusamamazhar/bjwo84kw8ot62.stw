<%@ Page Title="" Language="C#" MasterPageFile="~/ui/finance.Master" AutoEventWireup="true" CodeBehind="addincome.aspx.cs" Inherits="edusystemv1.ui.addincome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section id="main-content" style="background-color: #edf0f5;">
        <section class="wrapper">
            ...
            <h1 style="padding-left: 450px; color: black;"><strong>Add Income</strong></h1>
            ...
            <form class="form-horizontal style-form form-panel" id="form1" runat="server" style="height: 400px;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10" style="width: 800px">
                       ...
                       <asp:DropDownList ID="incometype" runat="server" required="required" DataSourceID="SqlDataSource1" DataTextField="incometype" DataValueField="id">
                                             </asp:DropDownList>

                                             <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DAconnectionstring %>" SelectCommand="SELECT [incometype], [id] FROM [incometypes]"></asp:SqlDataSource>
                ...
                <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label"> Date of Income<label style="color: red;">*</label></label>
                    <div class="col-sm-10" style="width: 800px">
                        <asp:ToolkitScriptManager ID="ToolkitScriptManager2" runat="server">
                        </asp:ToolkitScriptManager>

                        <asp:TextBox ID="dateofincome" runat="server" required="required" CssClass="form-control"></asp:TextBox>

                        <asp:CalendarExtender
                            ID="CalendarExtender2"
                            Format="dd-MM-yyyy"
                            TargetControlID="dateofincome"
                            runat="server" />
                        <br />
