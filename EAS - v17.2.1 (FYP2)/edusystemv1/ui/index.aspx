<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="SchoolManagementSystem.index" %>
...
<body class="homepage">
    ...
    <header id="header">
        ...
        <nav class="navbar navbar-inverse" role="banner" style="background-color:black; height:100px;">
            <div class="container">
    ...
    <section id="main-slider" class="no-margin">
        <div class="carousel slide">
            ...
            <div class="carousel-inner">
                ...
                <div class="item active" style="background-image: url(images/bgm.jpg); background-size: 1350px; height:520px">
                    <%--<div class="container">
                        <div class="row slide-margin">
                            ...
                            <div class="col-sm-6 hidden-xs animation animated-item-4">
                                <div class="slider-img">
                                    <img src="images/bgm.jpg" class="img-responsive">
                                </div>
                            </div>
    ...
    <section id="services1" class="service-item">
	   <div class="container">
           <div class="center wow fadeInDown">
                ...
                <br><br>
		<meta charset="utf-8" />
		<link rel="stylesheet" type="text/css" href="../ui/css/style1.css" media="all" />
		<link href='../css/css1.css' rel='stylesheet' type='text/css'>
	


           <div id='frame' style="margin-left:auto; margin-right:auto;">
    ...
    <section id="feature" style="background-color:#0099FF" >
        <div class="container">
           <div class="center wow fadeInDown">
                ...
                <div class="features">
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h2 style="color:black">Connects</h2>
                            <h4 style="color:black"><span>Connects student, teacher and parent together</span></h4>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h2 style="color:black">Accessed from anywhere</h2>
                            <h4 style="color:black">As its a website so you can access it from anywhere</h4>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h4 style="color:black">Different modules for academic, finance and administration staff</h4>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h2 style="color:black">Student Behavior Analytics (SBA)</h2>
                            <h4 style="color:black">Parents can now discuss behavior stats with teachers through SBA</h4>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h2 style="color:black">Notice Board</h2>
                            <h4 style="color:black">Now you can see all the new on the live notice board</h4>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h2 style="color:black">Online Fee Payment</h2>
                            <h4 style="color:black">Now you can pay online via visa/master card</h4>
                        </div>
                    </div><!--/.col-md-4-->
                </div><!--/.services-->
            </div><!--/.row-->    
            ...
            <div class="row">
                <div class="col-sm-6 wow fadeInDown">
                    <div class="skill">
                        ...
                        <div class="progress-wrap">
                             <h3 style="color:white">Quality of Education</h3>
                            <div class="progress">
                              <div class="progress-bar color3" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 97%">
                                <span style="width: 97%">97%</span>
                              </div>
                            </div>
                        </div>

                        <div class="progress-wrap">
                            <h3 style="color:white">Overall EAS</h3>
                            <div class="progress">
                              <div class="progress-bar color4" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 91%">
                                <span style="width: 91%">91%</span>
                              </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 wow fadeInDown" >--%>
                    <%--<img style="width:350px; height:350px" src="images/student.png"/>--%>
                    <%--<div class="accordion">
   ...
   <%-- <section id="feature1" style="background-color:MediumVioletRed">
        <div class="container">
            <div class="center wow fadeInDown">
                <h2 style="color:white">Our Braches</h2>
                <%--<p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p>
            --%>
     ...
     <%--</div>    
            ...
            <div class="partners">
                <ul>
                    <li> <img class="img-responsive wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms"></li>
                ...
                <div class="col-sm-8">
                    <div class="media contact-info wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        ...
                        <div class="media-body">
                            ...
                            <p>Call us on our Pakistan number: +92-332-304-3863</p>
                        </div>
                    </div>
                </div>
            </div>
