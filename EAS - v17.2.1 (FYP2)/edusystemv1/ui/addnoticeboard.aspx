<%@ Page Title="" Language="C#" MasterPageFile="~/ui/masterpager.Master" AutoEventWireup="true" CodeBehind="addnoticeboard.aspx.cs" Inherits="edusystemv1.ui.addnoticeboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <section id="main-content" style="background-color:#edf0f5;">
          <section class="wrapper">
              ...
              <h1 style="padding-left:330px; color:black;"><strong>Write Text on Notice Board</strong></h1>
