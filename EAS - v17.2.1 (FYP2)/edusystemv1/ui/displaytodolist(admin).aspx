<%@ Page Title="" Language="C#" MasterPageFile="~/ui/masterpager.Master" AutoEventWireup="true" CodeBehind="displaytodolist(admin).aspx.cs" Inherits="edusystemv1.ui.displaytodolist_admin_" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <section id="main-content" style="background-color:#edf0f5;">
          <section class="wrapper">
              ...
              <h1 style="padding-left:380px; color:black;"><strong>Display To Do List</strong></h1>
          	<br />
     ...
     <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource1">
          ...
          <asp:Table ID="Table2" runat="server" Border="1">
           <asp:TableRow>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DAconnectionstring %>" SelectCommand="SELECT * FROM [staff_notice] WHERE ([staffid] = @staffid)">
                         <SelectParameters>
