<%@ Page Title="" Language="C#" MasterPageFile="~/ui/masterpager.Master" AutoEventWireup="true" CodeBehind="editstudent.aspx.cs" Inherits="edusystemv1.ui.editstudent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <section id="main-content" style="background-color:#edf0f5;">
          <section class="wrapper">
              ...
              <h1 style="padding-left:450px; color:black;"><strong>Edit Student</strong></h1>
                  ...
                  <div class="form-panel" style="height:1050px;">
                     ...
                     <%--                  <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
                           ...
                           <div class="col-sm-10" style="margin-left:160px;  top:-5px;">
                                     <asp:button style="background-color:#647cac"  class="btn btn-theme btn-block"  type="submit" runat="server" OnClick="Unnamed_Click1" Text="SUBMIT" Height="43px" Width="100px"/>
