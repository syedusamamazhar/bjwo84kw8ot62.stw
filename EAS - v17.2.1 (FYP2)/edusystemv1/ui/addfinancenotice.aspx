<%@ Page Title="" Language="C#" MasterPageFile="~/ui/finance.Master" AutoEventWireup="true" CodeBehind="addfinancenotice.aspx.cs" Inherits="edusystemv1.ui.addfinancenotice" %>
                      ...
                      <form id="Form1" class="form-horizontal style-form" method="get" runat="server">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10" style="width:800px;">
                                 <asp:TextBox ID="noticetexts" required="required" MaxLength="110" CssClass="form-control" runat="server"></asp:TextBox>
                                     </div>
                          </div>
