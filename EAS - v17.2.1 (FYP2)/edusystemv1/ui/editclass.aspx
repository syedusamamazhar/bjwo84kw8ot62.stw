<%@ Page Title="" Language="C#" MasterPageFile="~/ui/masterpager.Master" AutoEventWireup="true" CodeBehind="editclass.aspx.cs" Inherits="edusystemv1.ui.editclass" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <section id="main-content" style="background-color:#edf0f5;">
          <section class="wrapper">
              ...
              <h1 style="padding-left:450px; color:black;"><strong>Edit Class</strong></h1>
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Class Teacher<label style="color:red;">*</label></label>
                               <div class="col-sm-10">
                                  <asp:DropDownList ID="teachers" runat="server" DataSourceID="teacher" DataTextField="staff_fame" DataValueField="staff_id"></asp:DropDownList><br/><br/>
