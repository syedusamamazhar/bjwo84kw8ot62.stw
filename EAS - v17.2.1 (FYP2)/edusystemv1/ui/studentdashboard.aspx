<%@ Page Title="" Language="C#" MasterPageFile="~/ui/student.Master" AutoEventWireup="true" CodeBehind="studentdashboard.aspx.cs" Inherits="edusystemv1.ui.studentdashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <section id="main-content" style="background-color:#edf0f5;">
         <section class="wrapper">
                 <h1 style="padding-left:390px; color:black;"><strong>Student Dashboard</strong></h1>
          	        <br />
